...
class local_go_redirects_table extends table_sql {
    /** @var bool Whether the current user can mutate redirects. */
    protected $canmanage;
     ...
     */
    public function __construct($uniqueid, $canmanage = true) {
        ...
        if ($this->canmanage) {
            ...
            $this->column_class('select', 'text-center');
            $this->column_class('allowguest', 'text-center');
